"""Local Parquet storage for ingested raw time series data."""
...
def save_raw_parquet(
    ...
    base_path: Union[str, Path] = "data/raw",
) -> Path:
    """Save DataFrame to {base_path}/{source}/{YYYY-MM-DD}.parquet.

    If file exists, load, append new rows, deduplicate on settlement_period, and write back.

    Args:
        df: DataFrame to save.
        source: Source identifier (e.g., 'carbon_intensity').

...
| `/api/v1/charging/recommend` | POST | Generate an optimized charging recommendation | `ChargingRequestCreate` | `ChargingRecommendation` | `driverService.getDriverRecommendation`, `optimizationService.runBackendOptimization` | **PARTIALLY IMPLEMENTED** |

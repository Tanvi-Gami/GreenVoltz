...
def mock_httpx_get():
    ...
    with patch("data_pipeline.collectors.carbon_intensity.httpx.get", return_value=mock_resp) as m:
        yield m
...
def test_empty_response_returns_empty_df():
    ...
    mock_resp.raise_for_status.return_value = None
    with patch("data_pipeline.collectors.carbon_intensity.httpx.get", return_value=mock_resp):
